...
export default function BottleActionHub() {
  ...
  const handleTransfer = async (e: React.FormEvent) => {
    ...
    if (requiresHWCN) {
      ...
      router.push(`/dashboard/move?serial=${bottle.serial}&dest=${destination}`);
      return;
    }
              ...
              <>
                ...
                {bottle.intendedLocationType === 'supplier' && (
                  <>
                    ...
                    <button 
                      type="button"
                      onClick={() => router.push(`/dashboard/move?serial=${serial}&action=divert`)}
              ...
              {bottle.locationType === 'supplier' ? (
                ...
                <div className={styles.successContainer} style={{padding: '1rem', textAlign: 'center'}}>
                  ...
                  <div style={{display: 'flex', flexDirection: 'column', gap: '0.75rem'}}>
                    ...
                    <button onClick={() => router.push('/dashboard')} className={styles.secondaryBtn}>Done</button>
                  </div>
                </div>
