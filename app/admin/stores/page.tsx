      ...
      <html>
        ...
        <body>
          ...
          <table>
            <thead>
              <tr>
                <th>Serial</th><th>Gas</th><th>Capacity</th><th>Current</th><th>Supplier</th><th>Returned By</th><th>Date Received</th>
              </tr>
            </thead>
            <tbody>${rows}</tbody>
          </table>
          ...
          <table style={{width: "100%", borderCollapse: "collapse"}}>
            <thead>
              <tr style={{background: "rgba(255,255,255,0.04)"}}>
                ...
                <th style={thStyle("returnedBy")} onClick={() => handleSort("returnedBy")}>Returned By <SortIcon col="returnedBy" /></th>
                <th style={thStyle("locationChangedAt")} onClick={() => handleSort("locationChangedAt")}>Date Received <SortIcon col="locationChangedAt" /></th>
              </tr>
            </thead>
            <tbody>
              {filtered.map(b => {
                ...
                return (
                  ...
                  >
                    ...
                    <td style={{padding: "0.85rem 1rem", fontSize: "0.9rem"}}>{b.returnedBy || "—"}</td>
