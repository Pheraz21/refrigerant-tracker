...
export default function AdminHWCNPrintPage() {
  const { id } = useParams();
  ...
  useEffect(() => {
    ...
    db.getHWCN(id as string).then(data => {
      setHwcn(data);
      if (data?.serial) {
        db.getUsageLogs(data.serial).then(setUsageLogs);
        db.getBottle(data.serial).then(setBottle);
      }
    });
  }, [id]);
  ...
  return (
    <div className="hwcn-container" style={{ maxWidth: "820px", margin: "0 auto", padding: "0.4rem", background: "#fff", color: "#000", minHeight: "100vh", fontFamily: "Arial, sans-serif" }}>
      ...
      <div className="no-print" style={{ display: "flex", justifyContent: "space-between", marginBottom: "0.75rem", padding: "0.75rem 1rem", background: "#111", borderRadius: "8px" }}>
        <button
          onClick={() => router.back()}
          style={{ background: "none", border: "none", color: "#00e5ff", display: "flex", alignItems: "center", gap: "0.5rem", cursor: "pointer", fontSize: "0.9rem", padding: 0 }}
        >
          <ArrowLeft size={18} /> Back
        </button>
        <button
          onClick={() => window.print()}
          style={{ background: "#00e5ff", color: "#000", border: "none", padding: "0.5rem 1.25rem", borderRadius: "4px", cursor: "pointer", display: "flex", alignItems: "center", gap: "0.5rem", fontWeight: "bold" }}
        >
          <Printer size={18} /> Print / PDF
        </button>
      </div>

      {/* Status banner (no-print) */}
      <div className="no-print" style={{
        marginBottom: "1rem", padding: "0.6rem 1rem", borderRadius: "6px",
        ...
        <span>
          {hwcn.hwcnStatus === "complete"
            ...
            : hwcn.hwcnStatus === "awaiting_consignee"
            ? "Awaiting Part E — go back to complete the consignee certificate."
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end", marginBottom: "0.4rem", paddingBottom: "0.4rem", borderBottom: "2px solid #333" }}>
        ...
        <div style={{ textAlign: "right" }}>
          ...
          <div style={{ fontSize: "0.9rem", fontWeight: "bold", color: "#222", marginBottom: "0.2rem" }}>
            Consignment Note <span style={{ fontSize: "0.6rem", fontWeight: "normal", color: "#555" }}>(England &amp; Wales)</span>
          </div>
          ...
          <div className="hwcn-section" style={{ margin: 0, minWidth: "240px" }}>
            ...
            <div style={{ padding: "0.4rem 0.6rem", fontSize: "0.78rem" }}>
              ...
              <div style={{ display: "flex", gap: "0.5rem", alignItems: "center", marginTop: "0.5rem" }}>
                ...
                <div className="sig-box" style={{ flex: 1, padding: "0.1rem 0.5rem" }}>{hwcn.engineer}</div>
              </div>
            </div>
          </div>
          ...
          <div className="hwcn-section" style={{ margin: 0, minWidth: "240px" }}>
            ...
            <div style={{ padding: "0.4rem 0.6rem", fontSize: "0.78rem" }}>
              ...
              <div style={{ display: "flex", gap: "0.5rem", alignItems: "center", marginTop: "0.3rem" }}>
                ...
                <div className="sig-box" style={{ flex: 1, padding: "0.1rem 0.5rem", minHeight: "1.6rem" }}>{hwcn.engineer}</div>
              </div>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "1.2rem", minWidth: "360px" }}>
              ...
              <div style={{ minWidth: "160px" }}>
                <div style={{ display: "flex", gap: "0.5rem", alignItems: "center", marginBottom: "0.3rem" }}>
                  ...
                  <div className="sig-box" style={{ flex: 1, minHeight: "2rem", padding: "0.15rem 0.5rem" }}>
